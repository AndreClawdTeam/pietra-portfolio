    ...
    <html lang="pt-BR" className="scroll-smooth">
      ...
      <body className={`${poppins.variable} font-sans font-light`}>
        ...
        <Script
          id="gtag-1"
          async={true}
          src="https://www.googletagmanager.com/gtag/js?id=AW-17059362533"
        />
        <Script
          id="gtag-2"
          async={true}
          src="https://www.googletagmanager.com/gtag/js?id=G-JHGW1PWY5H"
        />
        <Script
          id="gtag-3"
          dangerouslySetInnerHTML={{
            __html: `
              ...
              gtag('js', new Date());
              gtag('config', 'AW-17059362533');
              gtag('event', 'conversion', {
                  'send_to': 'AW-17059362533/Kpf5CKe1xsMaEOXtxMY_',
                  'value': 1.0,
                  'currency': 'BRL'
              });
              gtag('config', 'G-JHGW1PWY5H');
              (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
              new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
              j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
              'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
              })(window,document,'script','dataLayer','GTM-MRGMLF5R');
            `,
          }}
        />
        <noscript
          dangerouslySetInnerHTML={{
            __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MRGMLF5R" height="0" width="0" style="display:none;visibility:hidden"></iframe>`,
          }}
        />
      </body>
    </html>
