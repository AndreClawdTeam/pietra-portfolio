      ...
      <div>
        <div className="container mx-auto">
          ...
          <p className="text-muted-foreground mt-2">
            Descubra meus ebooks exclusivos com os segredos para uma vida mais
            saudável e equilibrada! Aqui você encontra guias práticos e
            completos para transformar sua relação com a alimentação de forma
